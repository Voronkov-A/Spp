...
public partial class ConnectTestClient : IConnectTestClient
{
    ...
    /// </summary>
    public async System.Threading.Tasks.Task<IConnectTestClient.AuthorizeClientResponse> Authorize(
    ...
    )
    {
        ...
        if ((int)response.StatusCode == 302 || 302 == -1)
        {
            ...
            return IConnectTestClient.AuthorizeClientResponse.Create302(response.StatusCode, response.Headers);
        }
        if ((int)response.StatusCode == 400 || 400 == -1)
        {
            ...
            return IConnectTestClient.AuthorizeClientResponse.Create400(response.StatusCode, response.Headers, content);
        }
        if ((int)response.StatusCode == 401 || 401 == -1)
        {
            ...
            return IConnectTestClient.AuthorizeClientResponse.Create401(response.StatusCode, response.Headers, content);
        }
        if ((int)response.StatusCode == Default || Default == -1)
        {
            ...
            return IConnectTestClient.AuthorizeClientResponse.CreateDefault(response.StatusCode, response.Headers, content);
        }
...
#pragma warning restore CS0162 // Code is unreachable
    ...
    )
    {
        ...
        return await Authorize(request, cancellationToken);
    }
    /// <summary>
...
#pragma warning restore CS0162 // Code is unreachable
    ...
    /// </summary>
    public async System.Threading.Tasks.Task<IConnectTestClient.GetUserInfoClientResponse> GetUserInfo(
        System.Net.Http.HttpRequestMessage request,
        System.Threading.CancellationToken cancellationToken = default
    )
    {
        ...
        if ((int)response.StatusCode == 200 || 200 == -1)
        {
            ...
            return IConnectTestClient.GetUserInfoClientResponse.Create200(response.StatusCode, response.Headers, content);
        }
        if ((int)response.StatusCode == 401 || 401 == -1)
        {
            var content = await System.Net.Http.Json.HttpContentJsonExtensions.ReadFromJsonAsync<Microsoft.AspNetCore.Mvc.ProblemDetails?>(
            ...
            return IConnectTestClient.GetUserInfoClientResponse.Create401(response.StatusCode, response.Headers, content);
        }
        if ((int)response.StatusCode == Default || Default == -1)
        {
            var content = await System.Net.Http.Json.HttpContentJsonExtensions.ReadFromJsonAsync<Microsoft.AspNetCore.Mvc.ProblemDetails?>(
            ...
            return IConnectTestClient.GetUserInfoClientResponse.CreateDefault(response.StatusCode, response.Headers, content);
        }
...
public partial interface IConnectTestClient : System.IDisposable
{
    ...
    /// Initializes an OAuth 2.0 flow using a response_type. See RFC 6749 (https://tools.ietf.org/html/rfc6749) for more details. 
    /// </summary>
    System.Threading.Tasks.Task<AuthorizeClientResponse> Authorize(
        string clientId,
        ResponseType responseType,
        string redirectUri,
        string scope,
    ...
    public class AuthorizeClientResponse
    {
        ...
        private AuthorizeClientResponse(
...
#pragma warning restore CS0162 // Code is unreachable
        ...
        public static AuthorizeClientResponse Create302(System.Net.HttpStatusCode code, System.Net.Http.Headers.HttpResponseHeaders headers)
        {
...
#pragma warning restore CS0162 // Code is unreachable
            ...
            return new AuthorizeClientResponse(statusCode: code, headers: headers);
        }

        public static AuthorizeClientResponse Create400(System.Net.HttpStatusCode code, System.Net.Http.Headers.HttpResponseHeaders headers, Microsoft.AspNetCore.Mvc.ProblemDetails content)
        {
...
#pragma warning restore CS0162 // Code is unreachable
            ...
            return new AuthorizeClientResponse(statusCode: code, headers: headers, content400: content);
        }

        public static AuthorizeClientResponse Create401(System.Net.HttpStatusCode code, System.Net.Http.Headers.HttpResponseHeaders headers, Microsoft.AspNetCore.Mvc.ProblemDetails content)
        {
...
#pragma warning restore CS0162 // Code is unreachable
            ...
            return new AuthorizeClientResponse(statusCode: code, headers: headers, content401: content);
        }

        public static AuthorizeClientResponse CreateDefault(System.Net.HttpStatusCode code, System.Net.Http.Headers.HttpResponseHeaders headers, Microsoft.AspNetCore.Mvc.ProblemDetails content)
        {
...
#pragma warning restore CS0162 // Code is unreachable
            ...
            return new AuthorizeClientResponse(statusCode: code, headers: headers, contentDefault: content);
        }
        ...
        public readonly struct HeaderCollection302
        {
            ...
            public string Location =>
                System.Linq.Enumerable.Single(_headers.GetValues("Location"));
        }
    }
...
#pragma warning restore CS0162 // Code is unreachable
    ...
    {
        private readonly UserInfo? _content200;
        private readonly Microsoft.AspNetCore.Mvc.ProblemDetails? _content401;
        private readonly Microsoft.AspNetCore.Mvc.ProblemDetails? _contentDefault;
...
#pragma warning restore CS0162 // Code is unreachable
        ...
        public static GetUserInfoClientResponse Create200(System.Net.HttpStatusCode code, System.Net.Http.Headers.HttpResponseHeaders headers, UserInfo content)
        {
            if ((int)code != 200 && 200 != -1)
#pragma warning disable CS0162 // Code is unreachable
            {
...
#pragma warning restore CS0162 // Code is unreachable
        ...
        public static GetUserInfoClientResponse CreateDefault(System.Net.HttpStatusCode code, System.Net.Http.Headers.HttpResponseHeaders headers, Microsoft.AspNetCore.Mvc.ProblemDetails content)
        {
            if ((int)code != Default && Default != -1)
#pragma warning disable CS0162 // Code is unreachable
            {
