...
public class SimpleCsharpTestClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public String getName() {
        return "simple-csharp-test-client";
    }
    ...
    public SimpleCsharpTestClientCodegen() {
        super();
        ...
        templateDir = "simple-csharp-test-client";
